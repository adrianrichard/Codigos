...
class App:
    ...
    def __init__(self):        
        ...
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=200, relief=tk.SOLID, padx=10, pady=10,bg='#1F704B')
        ...
        inicio = tk.Button(frame_form_fill, text="Ingresar", font=('Times', 15,BOLD), bg='#1F704B', bd=0, fg="#fff", command=self.verificar)
